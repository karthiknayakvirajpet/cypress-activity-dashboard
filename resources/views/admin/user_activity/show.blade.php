        ...
        <div class="col-md-12">
            <div class="card">
                <div class="card-header">
                    <div class="row">
                        <div class="col-md-8">
                            <h4>Activities of user: {{ $user->name }}</h4>
                        </div>
                        <div class="col-md-3">
                            <a href="/admin/add-user-activity/{{ $user->id }}">
                                <button type="button" id="add-activity" class="btn btn-warning float-right">Add User Activity</button>
                            </a>
                        </div>
                        <div class="col-md-1">
                            <a href="/admin/user-activities">
...
$(document).ready(function() {
    ...
    $('[name=delete]').click(function (){
        ...
        }).then((Delete) => 
        {
            ...
            {
                $.ajax({
                      url: "/admin/delete-user-activity/" + value,
                      type: 'GET',
                      success: function(){
                          swal({
                            title: "User Activity deleted successfully!",
                          }).then(function(){ 
                              location.reload();
                             }
                          );
